...
└─────────────────────────────────────────────────────────┘
     ...
     ▼ (if not critical)
┌─────────────────────────────────────────────────────────┐
│          Step 2: Coaching-Based Processing             │
│  ┌─────────────────────────────────────────────────────┐ │
│  │      Main Coaching Agent (GPT-4o-mini)             │ │
│  │      Using GROW Model + OARS Framework             │ │
│  │                                                     │ │
│  │  Coaching Phases:                                   │ │
│  │  • Goal (10%): Establish session intention         │ │
│  │  • Reality (60%): Deep exploration via OARS        │ │
│  │    - Minimum 10-15 exchanges                        │ │
│  │    - Reflect emotions & explore exceptions          │ │
│  │  • Options (20%): Parent-generated solutions        │ │
│  │  • Will (10%): Action commitment                    │ │
│  │                                                     │ │
│  │  Session ends when parent has their own plan       │ │
...
│  │  • GROW phase tracking → Coaching state            │ │
...
└─────────┬───────┘
          ...
          ▼
    ┌──────────┐
    │  GOAL    │──────► Establish session intention
    └─────┬────┘        "What would be helpful today?"
          │
          ▼
    ┌──────────┐
    │ REALITY  │──────► Deep exploration (60% of time)
    └─────┬────┘        • OARS framework
          │             • Min 10-15 exchanges
          │             • Reflect emotions
          │             • Explore exceptions
          ...
          ▼
    ┌──────────┐      NO     ┌─────────────────────────┐
    │Ready for │────────────►│ Continue Reality Phase  │
    │Options?  │             │ • More open questions   │
    └─────┬────┘             │ • Deeper reflection     │
          │ YES              └─────────────────────────┘
          ▼
    ┌──────────┐
    │ OPTIONS  │──────► Parent-generated solutions
    └─────┬────┘        • "What could you try?"
          │             • Collaborative suggestions
          │             • Evidence-based strategies
          ▼
    ┌──────────┐
    │   WILL   │──────► Action commitment
    └─────┬────┘        • "What will you do?"
          │             • Confidence check (1-10)
          │             • Anticipate barriers
          ▼
    Parent has their own plan ✓
```
